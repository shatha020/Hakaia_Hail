...
const LANGUAGES = {
  ar: {
    ...
    ui: {
      ...
      configApiKeyWarning: '⚠️ ضع مفتاح Gemini في app.js → CONFIG.GEMINI_API_KEY',
...
- لا تخترع معلومات غير مؤكدة — إذا لم تكن متأكداً، قل "يقولون..." أو "يروي الأجداد..."`,
  ...
  en: {
    ...
    ui: {
      ...
      configApiKeyWarning: '⚠️ Set your Gemini API key in app.js → CONFIG.GEMINI_API_KEY',
...
- Start with a friendly greeting.`,
  ...
  fr: {
    ...
    ui: {
      ...
      configApiKeyWarning: '⚠️ Définissez la clé Gemini dans app.js → CONFIG.GEMINI_API_KEY',
...
- Pas de markdown — texte continu.`,
  ...
  ur: {
    ...
    ui: {
      ...
      configApiKeyWarning: '⚠️ Gemini API key app.js میں سیٹ کریں',
